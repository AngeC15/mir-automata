...
public class ActionList extends Action {
	...
	public boolean apply(Entity e) {
		/*
		 * When we want to choose a random action among all available, we need to take
		 * all -1's weight with the same percentage depending on the number of
		 * total_weight and how many action with -1's weight left
		 */
