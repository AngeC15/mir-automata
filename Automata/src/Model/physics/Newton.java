...
public class Newton {
	...
	private boolean circleTest(PhysicsBody b1, PhysicsBody b2) {
		Vector2 d = new Vector2((float)b1.getTransform().getTranslateX() - (float)b2.getTransform().getTranslateX(),
								(float)b1.getTransform().getTranslateY() - (float)b2.getTransform().getTranslateY());
